<?php If (isset($SearchLang) == False){include 'LanguageEN.php';} if (isset($Year) == False){$Year=-1;$Playoff=False;$MaximumResult=0;$Team=0;$HistoryFarm=False;$MinGP=0;$lang="en"; $ACSQuery=True;$PlayersRosterPossibleOrderField=array();$OrderByInput="";$AvailableForTrade=False;$Injury=False;$Retire=False;$Type=0;}?> 
