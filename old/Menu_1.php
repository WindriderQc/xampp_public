...
<nav>
    <div class="logo">
        <a href="index1.php"> <img src="images/lhsqc_logo_2.png" alt="LHSQC" class="header-logo"></a>
    </div>
    <ul>
        ...
        <li><a href="#">Coach's Corner</a><ul>
            <li><a href="WebClientRoster_1.php?TeamID=<?php echo $CookieTeamNumber ?>">Roster Editor</a></li>
            <li><a href="WebClientLines_1.php?TeamID=<?php echo $CookieTeamNumber ?>">Lines Editor</a></li>
        </ul></li>
    ...
    <ul class="nav-mobile-menu">
        <li class="active">
            <div class="row">
                ...
                <div class="col"> <a href="index1.php">HOME </a></div>
                <div class="col"><div class="logo"><img src="images/lhsqc_logo_2.png" alt="LHSQC" class="header-logo"></div></div>
            </div>
        ...
        <li><div> Coach's Corner  <i class="fa fa-chevron-right"></i></div><ul>
                                <a class=" " href=WebClientRoster_1.php?TeamID=<?php echo $CookieTeamNumber ?>">Roster Editor</a>
                                <a class=" " href="WebClientLines_1.php?TeamID=<?php echo $CookieTeamNumber ?>">Lines Editor</a>
        </ul>
        </li>
        <li><a href="Schedule.php">Schedule</a></li>
