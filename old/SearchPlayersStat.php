<?php If (isset($SearchLang) == False){include 'LanguageEN.php';} if (isset($MaximumResult) == False){$Year = -1;$PlayersStatPossibleOrderField = array();$Playoff= Null;$OrderByInput = "";$lang="en";$ACSQuery = True;$MinGP = False;$MaximumResult=0;$Search=True;$Team=0;}?> 
